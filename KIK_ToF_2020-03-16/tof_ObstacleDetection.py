...
class ObstacleDetection(object):
    def __init__(self, cell_length=20, grid_length=20, min_obstacle_height=50, flag_3d_filter=False):
        ...
        self.Ground_Threshold_Grids = math.ceil(self.Ground_Threshold / self.TOF_Grid_Unit_Length)  # grid
...
if __name__ == '__main__':
    ...
    fpaths = '/home/reid/Downloads/KIK_ToF_2020-03-16/tof_data/tof_data_20200316/sequence_1/'
